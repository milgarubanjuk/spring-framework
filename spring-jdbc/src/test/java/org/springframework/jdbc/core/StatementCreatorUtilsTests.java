...
public class StatementCreatorUtilsTests {
	...
	@Test 
	public void testSetParameterValueWithStringAndVenderSpecificType() throws SQLException {
		StatementCreatorUtils.setParameterValue(preparedStatement, 1, Types.OTHER, null, "test");
		verify(preparedStatement).setString(1, "test");
	}
	
	@Test 
	public void testSetParameterValueWithNullAndVenderSpecificType() throws SQLException {
